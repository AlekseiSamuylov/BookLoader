...
public class BookService {
    ...
    public void updateBook(Long bookId, BookDto bookDto) {
        ...
        BookEntity bookEntity = bookConverter.convertToDbo(bookDto);
        if (bookEntity.getName() != oldBook.getName()) {
            oldBook.setName(bookEntity.getName());
        }
        if (bookEntity.getDescription() != oldBook.getDescription()) {
            oldBook.setDescription(bookEntity.getDescription());
        }
