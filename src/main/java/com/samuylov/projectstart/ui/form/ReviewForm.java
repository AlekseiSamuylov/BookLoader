...
@SpringComponent
@ViewScope
public class ReviewForm extends AbstractForm<ReviewDto, ReviewEntity> {
    ...
    private void postConstruct() {
        ...
        textTextField = getTextField("Review text", "Enter text...");
    ...
    @Override
    public void init(ReviewDto dto, CloseFormFunction closeFunc) {
        this.dto = dto;
